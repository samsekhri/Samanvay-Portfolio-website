...
export default async function LinksPage() {
  ...
  return (
    <div className="relative">
      <title>Links | Samanvay Sekhri</title>
        ...
        <GridWrapper>
          <div className="mx-auto max-w-xl text-center md:mt-8">
            <p className="leading-8 text-text-secondary">
              I&apos;m a extraordinary developer with a love for design and a knack for tinkering. this site is where I stretch the limits of what&apos;s possible, serving as my creative playground for testing new ideas and discovering what works!
            </p>
          </div>
        </GridWrapper>
        <GridWrapper>
          <div className="flex justify-center space-x-4 py-4">
            ...
            <Button href="mailto:samsekhri.s2003@gmail.com" variant="secondary">
              Email me
            </Button>
          </div>
        </GridWrapper>
