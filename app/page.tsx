        ...
        <section>
          <div className="relative text-balance">
            <GridWrapper>
              ...
              >
                Hey, I&apos;m Samanvay! <br /> Welcome to my corner of the
                internet!
              </AnimatedText>
            </GridWrapper>
            <GridWrapper>
              <div className="mt-4 text-center md:mt-8">
                ...
                >
                  I&apos;m a extraordinary developer with a love for design and
                  code. this site is where I stretch the limits
                  of what&apos;s possible, serving as my creative playground for
                  testing new ideas and discovering what works!
                </AnimatedText>
              </div>
            </GridWrapper>
          </div>
