    ...
    <BentoCard linkTo="/speaking" height="h-[276px]">
      ...
      >
        ...
        <div className="flex justify-around">
          ...
          >
            <SecondaryPhoto imgSrc="/Sam-Headshot-2.jpg" />
          </motion.span>
          ...
          >
            <SecondaryPhoto imgSrc="/Sam-Headshot-4.jpg" />
          </motion.span>
        </div>
        {/* Gradient overlay */}
        ...
        <div className="absolute bottom-6 left-6 z-50 grid h-full grid-cols-2 grid-rows-2 items-end gap-8">
          <div className="col-1 row-start-2 text-balance">
            <h2 className="mb-2 font-medium">Experimenting</h2>
            <p className="text-text-secondary">Love bringing ideas to life</p>
          </div>
        </div>
      </div>
    </BentoCard>
